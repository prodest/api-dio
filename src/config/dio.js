const dioLatestUrl = process.env.DIO_LATEST_URL || 'http://dio.es.gov.br/apifront/portal/edicoes/ultimas_edicoes/';
const dioSearchUrl = process.env.DIO_BUSCA_URL || 'http://www.dio.es.gov.br/busca/busca/buscar';
const pdfUrl = process.env.DIO_PDF_URL || 'http://dio.es.gov.br/portal/edicoes/download';
